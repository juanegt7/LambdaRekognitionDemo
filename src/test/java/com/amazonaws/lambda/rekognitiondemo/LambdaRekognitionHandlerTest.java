package com.amazonaws.lambda.rekognitiondemo;
...
public class LambdaRekognitionHandlerTest {
    ...
    @Test
    public void testLambdaRekognitionHandler() {
        LambdaRekognitionHandler handler = new LambdaRekognitionHandler(s3Client);
